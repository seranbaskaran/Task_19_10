...
/* function validatePlayersCount1(player,role) {
...
function updateSelectedPlayers() {
    selectedPlayers = allPlayer.filter(player => player.visible);
    console.log(selectedPlayers);
}
function updateChoosedPlayerSection() {
    ...
    // const viceCaptain = selectedPlayers.find(player => player.vicecaptain);
    selectedPlayers.forEach(player => {
